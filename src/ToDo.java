...
public class ToDo {
    ...
    static void insertTodo(Connection conn, String text) throws SQLException {
        PreparedStatement stmt = conn.prepareStatement("INSERT INTO todos VALUES (NULL, ?, false)"); //causes identity to auto incremnent
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //after identity can put (0,0) starting point and how many it increases
